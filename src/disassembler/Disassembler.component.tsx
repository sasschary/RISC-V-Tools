...
export default class Disassembler extends React.Component<
  DisassemblerProps,
  DisassemblerState
> {
  render() {
      ...
      <div className="tool-container">
        <Form onSubmit={this.handleDisassemble}>
          ...
          <InputGroup>
            ...
            <FormControl
              onChange={(evt) =>
                this.setState({ instruction: evt.target.value })
              }
            />
            <InputGroup.Append>
  ...
  handleDisassemble(
    ...
    evt.preventDefault();
    const disassembled = disassembler.disassembleInstruction(
